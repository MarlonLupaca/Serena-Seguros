...
import com.serena.modules.core.polizas.dto.CambioEstadoEndosoRequest;
import com.serena.modules.core.polizas.dto.EndosoAdminResponse;
...
@PreAuthorize("hasAnyRole('TECNICO', 'EJECUTIVO', 'COMERCIAL', 'OPERATIVO')")
