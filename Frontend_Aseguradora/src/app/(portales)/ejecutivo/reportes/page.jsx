...
import { MdInsertChart, MdDescription, MdReportProblem, MdGroups, MdAccountBalance } from 'react-icons/md';
    ...
    <div className="flex flex-col gap-5 p-6">
      ...
      <Card titulo="Notas" icon={MdAccountBalance}>
        <p className="text-xs text-text-soft leading-relaxed">
          ...
          al cargar la vista. Para historicos por periodo se proyecta extender el modulo en una fase posterior.
        </p>
      </Card>
    </div>
  );
